				...
				<div class="login_area">
					...
					<form method="POST" enctype="multipart/form-data">
						<center>
							...
							<textarea name="short_desc" placeholder="Short Description" style="width:80%;height:100px;margin-top:10px;"><?php echo $products['short_desc'];?></textarea>
							...
							<img src="images/<?php echo $products['img_path']?>" alt="" style="height:150px; width:200px; margin-top:20px;" />
