...
<?php
	function addNewOrder($cus_id, $cus_add,$amount)
	{
		$query="INSERT INTO `order`(`customer_id`, `customer_address`, `order_date`, `shipping_date`, `order_amount`, `delivery_status`)VALUES ('$cus_id', '$cus_add',curdate(), curdate(), '$amount', 'pending');";
